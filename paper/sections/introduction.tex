...
These failure modes matter in high-stakes settings (robotics, surveillance, simulation validation), where a system must not only describe what it sees but also flag implausible or impossible events. Existing video understanding benchmarks provide broad coverage, but many tasks can be solved with weak temporal reasoning (e.g., static frames, language priors, or dataset artifacts), which reduces diagnostic value.
